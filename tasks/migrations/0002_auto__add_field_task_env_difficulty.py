...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.env_difficulty'
        db.add_column(u'tasks_task', 'env_difficulty',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.env_difficulty'
        db.delete_column(u'tasks_task', 'env_difficulty')
